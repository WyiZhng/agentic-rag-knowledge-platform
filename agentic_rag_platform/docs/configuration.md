...
|----------|---------|-------------|
| `PROJECT_NAME` | `agentic_rag_platform` | Display name for the project |
...
| `POSTGRES_DB` | `agentic_rag_platform` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `agentic_rag_platform` | Service name in Logfire dashboard |
